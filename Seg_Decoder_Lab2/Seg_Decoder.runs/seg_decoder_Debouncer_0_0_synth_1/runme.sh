...
HD_PWD='C:/vivado_workspace/Seg_Decoder_Lab2/Seg_Decoder.runs/seg_decoder_Debouncer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_decoder_Debouncer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seg_decoder_Debouncer_0_0.tcl
